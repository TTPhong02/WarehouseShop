    ...
    <div>
        <div class="p-home__main--header">
            ...
            <div class="p-home__main--table">
                <div class="p-grid">
                    <MUserDetail :filterParent="filter" ref="nextPageRef" refsPreviousPage="previousPageRef"  @totalRecord="hanldeDataPagingTotalRecord"  @totalPage="hanldeDataPagingTotalPage" @checkedIDs="handleListChecked"  :btnShowForm="btnShowForm"  ></MUserDetail>
                </div>
        ...
        <UserForm :IdEntity="this.idEntity" :btnShowForm="btnShowForm"  v-if="showForm" :FormMode="this.FormMode" :closeForm="btnCloseForm" ></UserForm>
...
export default {
    ...
    methods :{
        ...
        */
        btnsearch(){
            this.emitter.emit("loadDataPagingUsers");
        },
        /**
