    ...
    <div class="p-login">
        ...
        <div class="p-login-form">
            ...
            <div class="p-login-action">
                <router-link to="/forget" class="p-login-form-forget">Quên mật khẩu?</router-link>
...
export default {
    ...
    methods: {
         ...
         * Author by: TTPhong(22/02/2024)
         */
        async takeDataCartOfUser(id){
            var res = await cartItemsService.getByUserId(id);
            if(res){
            ...
            try{
                ...
                switch (res.status) {
                    case 201:
                        ...
                        var item = await cartItemsService.getByUserId(res.data.Data.Users.UsersId);
                        localStorage.setItem("CartItems",JSON.stringify(item.data));
                        this.$router.push("/");
                        break;                   
                }
            }catch(error){
